define('wo/module/app_function',['wo_config','base_package','ua',"new_alert_v2","commom_function"],function(require, exports)
{
	...
	//������apps�ڷ���������app��POCO���  add by manson 2014.2.19
	...
	exports.app_publish = function(is_async_upload ,callback)
	{
		if( this.is_world_app() )
        {
			alert('PocoWorld.send')                        
            
			PocoWebViewJavascriptBridge.callHandler( 'PocoWorld.send' , {'is_async_upload' : is_async_upload },callback)
		}
	}

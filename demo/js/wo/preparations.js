define("wo/preparations",["frame_package",'wo_config','commom_function','app_function'],function(require, exports)
{
	...
	var default_index_route = wo_config.default_index_route;
    
    if( app_function.is_world_app())
    {
        if(is_first_time_to_app)
        {
    ...
    [   
        ...
        "about",
        "category", "charm_rank", "choose_my_image", "cmt", "cmt_notice","category_list",
        "dating_game", "dating_list", "doorplate_last", "doorplate_list","daily",
        "edit",  "event", "edit_wonderful_pics", 
        "friend","fans", "follow","font_page", 
        "get_friends_list","gallery", 
         "hot_img", 
        "index","ios_btn_view",
        "last", "like_notice", "login", "like_photo_list", 
        "message", "my", "message_list", "my_image_wall", "my_wallet","my_world", "my_life_element","micro_app",
        "new_img", "news", "notice_list", 
        "pics_rank", "publish", "publish_more_topic",
        "rank_pic_list", "recommend", "recommend_me", "red_package", "register", 
        "search_result",  "send_gift",  "set_location", "setup","same_city", "select_wonderful_pics_type","setup_common",
    ...
    //window.localStorage.setItem('category_nav',"index");// 每次进入页面点击关注初始化进入index页面

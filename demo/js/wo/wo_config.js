define('wo/wo_config',[],function(require, exports)
{
	...
	wo_config.photowall_spacing = 1												//瀑布流间距
	wo_config.last_page_container_spacing = 0									//最终页间距
    ...
    wo_config.ajax_url.recommend_friend_list = ajax_url_path + "recommend_friend_list_v2.php"
    ...
    wo_config.ajax_url.get_choose_my_image = ajax_url_path + "get_choose_my_image_v2.php"
    wo_config.ajax_url.update_my_image_box = ajax_url_path + "update_my_image_box.php"
    wo_config.ajax_url.get_my_wonderful_article_list = ajax_url_path + "get_my_wonderful_article_list_v2.php"
    ...
    wo_config.ajax_url.get_user_photos_profile_achievement = ajax_url_path + "get_user_photos_profile_achievement_v2.php"
    ...
    wo_config.ajax_url.check_is_new_admin = ajax_url_path + "check_is_new_admin.php"
    wo_config.ajax_url.font_page = ajax_url_path + "font_page.php"
	wo_config.ajax_url.category_list = ajax_url_path + "category_list.php"
    wo_config.ajax_url.my_user_info = ajax_url_path + "my_user_info.php"    
    wo_config.ajax_url.get_my_wonderful_type = ajax_url_path + "get_my_wonderful_type.php"
    wo_config.ajax_url.add_wonderful_pics = ajax_url_path + "add_wonderful_pics.php"
	wo_config.ajax_url.fans_list_v2 = ajax_url_path + "user_fans_list_v2.php"
	wo_config.ajax_url.fans_list_v2 = ajax_url_path + "user_fans_list_v2.php"
	 wo_config.ajax_url.follow_list_v2 = ajax_url_path + "user_follow_list_v2.php"
